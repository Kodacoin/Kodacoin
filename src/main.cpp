...
#if defined(NDEBUG)
# error "Kodacoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Kodacoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 6 * 60;
